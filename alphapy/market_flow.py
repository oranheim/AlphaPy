...
from alphapy.analysis import Analysis, run_analysis
from alphapy.data import get_market_data
from alphapy.globals import PD_INTRADAY_OFFSETS, PSEP, SSEP
...
from alphapy.variables import Variable, vmapply
...
def market_pipeline(model, market_specs):
    ...
    if system_specs:
        ...
        system = System(system_name, longentry, shortentry, longexit, shortexit, holdperiod, scale)
