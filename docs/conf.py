...
latex_documents = [
    (master_doc, "AlphaPy.tex", "AlphaPy Documentation", "Mark Conway, Robert D. Scott II", "manual"),
]
...
man_pages = [(master_doc, "alphapy", "AlphaPy Documentation", [author], 1)]
...
texinfo_documents = [
    (
        ...
        author,
        "AlphaPy",
        "AutoML for Data Scientists and Speculators",
        "Miscellaneous",
    ),
]
